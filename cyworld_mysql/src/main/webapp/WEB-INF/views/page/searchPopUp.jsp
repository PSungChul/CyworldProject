...
<link rel="stylesheet" href="/cyworld_mysql/resources/css/searchPopUp.css">
				...
				<c:if test="${ searchType eq 'name' }">
					<c:forEach var="name" items="${ list }">
						<div class="wantSearch">
							<figure>
								<!-- 검색된 유저의 미니미 -->
								<input class="memberMinimi" type="image" src="/cyworld_mysql/resources/minimi/${ name.minimi }" value="${ name.name }" onclick="opener.location.href='main.do?idx=${ name.idx }'; searchClick();">
								<!-- 검색된 유저의 이메일 -->
						...
						<div class="wantSearch">
							<figure>
								...
								<c:if test="${ id.platform eq 'cyworld' }">
									<!-- 검색된 유저의 미니미 -->
									<input class="memberMinimi" type="image" src="/cyworld_mysql/resources/minimi/${ id.minimi }" value="${ id.userID }"  onclick="opener.location.href='main.do?idx=${ id.idx }'; searchClick();">
								...
								<c:if test="${ id.platform ne 'cyworld' }">
									<!-- 검색된 유저의 미니미 -->
									<input class="memberMinimi" type="image" src="/cyworld_mysql/resources/minimi/${ id.minimi }" value="socialUser"  onclick="opener.location.href='main.do?idx=${ id.idx }'; searchClick();">
