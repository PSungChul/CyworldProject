...
<link rel="stylesheet" href="/cyworld_mysql/resources/css/gallery.css">
<link rel="stylesheet" href="/cyworld_mysql/resources/css/reset.css">
<link rel="stylesheet" href="/cyworld_mysql/resources/css/animate.css">
			...
			<div class="right-dashed-line">
				<div class="right-gray-background">
					...
					<audio class="mp3" controls>
						<source src="/cyworld_mysql/resources/sound/main.mp3" type="audio/mp3">
					</audio>
										...
										<div class="type_galleryFile">
											...
											<c:if test="${ vo.galleryFileName ne 'no_file' }">
												...
												<c:if test="${ vo.galleryFileExtension eq 'image' }">
													<div class="ImgPosition"><img class="myImg" src="/cyworld_mysql/resources/upload/${ vo.galleryFileName }"/></div>
												</c:if>
												<!-- 확장자가 video일 경우 -->
												<c:if test="${ vo.galleryFileExtension eq 'video' }">
													<div class="VideoPosition">
														<!-- video태그 autoplay : 자동 재생 / controls loop : 반복 재생 / muted : 음소거 -->
														<video class="myVideo" autoplay controls loop muted src="/cyworld_mysql/resources/upload/${ vo.galleryFileName }"/>
													</div>
												</c:if>
											</c:if>
										</div>
