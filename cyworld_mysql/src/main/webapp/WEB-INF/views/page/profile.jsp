...
<link rel="stylesheet" href="/cyworld_mysql/resources/css/yourProfile.css">
					...
					<aside id="right-aside" class="scrollBar">
						...
						<form>
							<div class="modify-user-profile">
								...
								<!-- 미니미 수정 -->
								<input class="minimi-main" type="button" src="/cyworld_mysql/resources/minimi/${ signVo.minimi }" onclick="minimiPopUp();">
								<!-- 해당 미니홈피 유저의 idx -->
								<input name="idx" type="hidden" value="${ signVo.idx }">
								<!-- 해당 미니홈피 유저의 플랫폼 -->
