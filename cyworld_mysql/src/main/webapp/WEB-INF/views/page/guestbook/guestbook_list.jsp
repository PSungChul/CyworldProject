...
<link rel="stylesheet" href="/cyworld_mysql/resources/css/guestbook.css">
<link rel="stylesheet" href="/cyworld_mysql/resources/css/animatemin.css">
							...
							<div class="guestbook_box">
								<form>
									...
									<div class="GuestContent" >
										<!-- 방명록 작성자의 미니미 -->
										<img class="GuestMinimi"src="/cyworld_mysql/resources/minimi/${ vo.guestbookMinimi }"/>
										<!-- 비밀글 구역 -->
										<div class="GuestText">
