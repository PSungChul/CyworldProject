...
<link rel="stylesheet" href="/cyworld_mysql/resources/css/login.css">
		...
		const naverLogin = new naver.LoginWithNaverId(
				{
					...
					callbackUrl: "http://localhost:9090/cyworld_mysql/login_naver_callback.do", // 로그인을 하고 정보동의 후 이동할 페이지 - 네이버에서 미리 등록해야한다.
